...
def plot_data(csv_file_path, start_time=None, end_time=None, foxglove_offset=0.0):
    ...
    if {'cmd_vel_linear_x', 'cmd_vel_angular_z'}.issubset(df.columns):
        ...
        #ax3b.set_title(r'\textbf{Measured vs.\ commanded velocities, Surge and Yaw rate}')
...
if __name__ == "__main__":
    csv_path = "/home/polaris_pz/Downloads/recordings_final_autonomy_lake4/surge_and_yaw_final_01_2026_06_03-10_16_52/csv_export/velocity_cmd_vs_measured.csv"
