...
def plot_data(csv_file_path):
    ...
    fig4.tight_layout()
    fig4.savefig(os.path.join(out_dir, 'xy_view_sqaure.png'))
    ...
    ax5.set_ylim(ry.min() - 1, ry.max() + 1)
    ...
    gif_path = os.path.join(out_dir, 'xy_animation_sqaure.gif')
...
if __name__ == "__main__":
    csv_path = "/home/polaris_pz/Autonomy_analyzation/orca_tracking_csv_export_Autonomy_grid_no_current_01_very_good/tracking_errors_wide.csv"
    plot_data(csv_path)