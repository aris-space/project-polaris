...
if __name__ == "__main__":
    csv_path = "/home/polaris_pz/Downloads/recordings_final_autonomy_lake4/aut_no_z_below_rectangle_04_2026_06_03-13_05_50/csv_export/tracking_errors_wide.csv"
    ...
    plot_data(
        csv_path,
        start_time=18.0,   # None = plot the entire recording (no cropping)
        end_time=None,
